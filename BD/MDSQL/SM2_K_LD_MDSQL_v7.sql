CREATE OR REPLACE PACKAGE sm2_k_ld_MDSQL IS
  ...
  */
  ...
  TYPE t_r_his_proc IS RECORD(
    ...
    nom_script       VARCHAR2(100),
    des_estado_scrip VARCHAR2(20),
    id_proceso       NUMBER, -- Añadido 27/10/2022
    num_orden        NUMBER); -- Añadido 27/10/2022
  ...
  */ ----------------------------------------------------------------------------------------                                  
  ...
  || p_lista_obj_his               : Lista de objetos a generar con histórico
  || p_nom_BBDD                    : BBDD
  || p_nom_esquema                 : Esquema
  || p_mca_HIS                     : Genera histórico (valores S y N)
  || p_nom_BBDD_HIS                : BBDD Histórico
  ...
  */ ----------------------------------------------------------------------------------------
    procedure p_repara_script(p_id_proceso        IN NUMBER,
                              ...
                              p_nom_script_lanza  OUT NOCOPY VARCHAR2,
                              p_script_lanza      OUT NOCOPY VARCHAR2, -- Modificado 16/11/2022 - Pasa de tipo t_t_script a VARCHAR2
  ...
  || p_lista_errores               : Lista de errores
  */ ----------------------------------------------------------------------------------------
  procedure p_descartar_script(p_script            IN t_t_linea, -- Modificado 16/11/2022 - Pasoa de tipo t_t_script a t_t_linea
                               p_id_proceso        IN NUMBER,
                               p_cod_usr           IN VARCHAR2,
